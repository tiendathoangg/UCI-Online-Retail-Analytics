...
-- The matching number of missing values from description and customer_id confirms the successful uploading.
...
WHERE 
	duplicate_rank > 1
LIMIT 20; -- After this code, we can identify which invoice has exact duplicates over the 8 defined partitioned by features.
